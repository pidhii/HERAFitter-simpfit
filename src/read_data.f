...
C         print *,' LW 29.07.16 partial chi2 in q2 bins'
         iq2bin = GetBinIndex(NDATASETS,'Q2')
         Q2valTmp  = AbstractBins(iq2bin,npoints)
C         print *,'     Q2valTmp = ', Q2valTmp
         if ( (Q2valTmp.ge.3.5).and.(Q2valTmp.lt.10) ) then
           JSETQ2(npoints) = 101
           DATASETLABEL(101) = '3.5 <= Q2 < 10'
         elseif ( (Q2valTmp.ge.10).and.(Q2valTmp.lt.100) ) then
           JSETQ2(npoints) = 102
           DATASETLABEL(102) = '10 <= Q2 < 100'
         elseif ( (Q2valTmp.ge.100).and.(Q2valTmp.lt.1000) ) then
           JSETQ2(npoints) = 103
           DATASETLABEL(103) = '100 <= Q2 < 1000'
         elseif ( (Q2valTmp.ge.1000).and.(Q2valTmp.lt.10000) ) then
           JSETQ2(npoints) = 104
           DATASETLABEL(104) = '1000 <= Q2 < 10000'
         elseif ( (Q2valTmp.ge.10000).and.(Q2valTmp.lt.51000) ) then
           JSETQ2(npoints) = 105
           DATASETLABEL(105) = '10000 <= Q2 <= 50000'
         endif
